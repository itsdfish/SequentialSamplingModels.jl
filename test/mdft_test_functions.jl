...
function run_tests(parms; Ma, Ms, Mc)
    ...
    attraction = test_context_effect(parms, rand_parms, Ma; test_func = test_attraction)
    compromise = test_context_effect(parms, rand_parms, Mc; test_func = test_compromise)
    similarity = test_context_effect(parms, rand_parms, Ms; test_func = test_similarity)
